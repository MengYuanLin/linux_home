;; -*- coding:utf-8; mode:emacs-lisp; mode:slime; -*-

(require 'slime)	;tell emacs to enter slime mode when editing a lisp file
...
(setq inferior-lisp-program "/usr/bin/sbcl"
      ...
      common-lisp-hyperspec-root "file:///home/mengyuan/.emacs.d/HyperSpec/"
...
(setf slime-translate-to-lisp-filename-function
      (lambda (file-name)
	(subseq file-name (length "/ssh:mengyuan@meng.com:")))
      slime-translate-from-lisp-filename-function
      (lambda (file-name)
	(concat "/ssh:mengyuan@meng.com:" file-name)))
...
;(defslime-start abcl "/home/meng/bin/abcl")
